...
<body>
    ...
    <div style="margin-bottom:10px">
    	 ...
    	 <a href="listEmployee" onclick="searchEmployee(this)">Search</a>
         <a href="listEmployee" onclick="setStatusParam(this)" style="margin-left:10px">Clear Search</a>
    </div>
    <table border=1>
        <thead>
            <tr>
    			...
    			<c:when test="${employeeList != null && employeeList.size() > 0}">
        			<c:forEach items="${employeeList}" var="employee">
		                <tr>
		                    ...
		                    <td><a href="restore?empId=<c:out value="${employee.empId}"/>">Restore</a></td>
		                    </c:if>
		                    <c:if test = "${employee.isDeleted == false}">
		                    <td><a href="edit?empId=${employee.id}">Update</a></td>
    ...
    <p><a href="insert">Add Employee</a></p>
